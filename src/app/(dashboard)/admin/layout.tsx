...
export default function AdminLayout({
  ...
  return (
    ...
    <div className="flex min-h-dvh" style={{ background: "#F4F4F6" }}>
      ...
      >
        ...
        >
          <button
            ...
            className="w-full flex items-center gap-3 px-3 py-3 min-h-[48px] rounded-lg text-sm font-medium
      ...
      <div className="flex min-h-dvh flex-1 flex-col min-w-0">
        ...
        >
          <div className="flex items-center gap-3 min-w-0">
            ...
            <div className="flex items-center gap-2 min-w-0">
              <Shield size={16} className="flex-shrink-0" style={{ color: "#F7941D" }} />
              <h1
        ...
        <MobileBottomNav
          tabs={[
            ...
            { href: "/admin/users", label: "Users", icon: Users },
            { href: "/admin/financials", label: "Money", icon: DollarSign },
            { href: "/admin/assignments", label: "Match", icon: UserCheck },
          ]}
